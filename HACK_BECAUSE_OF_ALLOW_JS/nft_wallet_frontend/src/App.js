...
const App = () => {
    ...
    const checkTokenCreated = async () => {
        try {
            const result = true; //FIX await actor.token_created();
    ...
    return (<div className="min-h-screen bg-gray-100">
      <Header actor={actor} setActor={setActor} isAuthenticated={isAuthenticated} setIsAuthenticated={setIsAuthenticated} tokenCreated={tokenCreated} setTokenCreated={setTokenCreated}/>
        <div><TokenInfo totalSupply={totalSupply}/></div>
        <div className="mx-auto">
            {isAuthenticated ? (<div className="grid grid-cols-1 gap-8 px-4 md:grid-cols-4 lg:grid-cols-3">
