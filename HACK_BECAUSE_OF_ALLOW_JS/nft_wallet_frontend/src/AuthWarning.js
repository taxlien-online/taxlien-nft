...
const FullPageAuthWarning = ({ showIdentity }) => {
    return (<div className="bg-infinite -my-8 h-screen w-screen px-0 text-white">
      <main className="flex flex-grow items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="rounded-md border-l-4 border-white bg-black bg-opacity-30 p-6 shadow-lg">
            <div className="mb-4 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="mr-3 h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
