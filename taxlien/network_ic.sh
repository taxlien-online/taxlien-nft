...
dfx --ic identity new alice --storage-mode=plaintext  --ic || true

dfx identity use alice --ic

ALICE_PRINCIPAL=$(dfx identity get-principal  --ic)

dfx identity new bob --storage-mode=plaintext  --ic || true

dfx identity use bob  --ic

BOB_PRINCIPAL=$(dfx identity get-principal  --ic)

dfx identity new icrc7_deployer --storage-mode=plaintext  --ic || true

dfx identity use icrc7_deployer --ic
