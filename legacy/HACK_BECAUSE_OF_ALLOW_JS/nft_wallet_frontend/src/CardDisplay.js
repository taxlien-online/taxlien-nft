...
const Card = ({ icon, title, value }) => (<div className="border-infinite/20 hover:border-infinite/40 transform rounded-xl border bg-white/80 p-6 shadow-lg backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl">
...
const CardDisplay = ({ cards, loading }) => {
    ...
    return (<div className="bg-infinite/30 mb-8 p-8 shadow-lg backdrop-blur-md transition-all duration-500 hover:shadow-xl">
